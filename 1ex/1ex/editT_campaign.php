...
<html>
<head>
    <title>Edit Toys Campaign</title>
...
<div class="col-md-10 content">
    <h2 class="white">EDIT <span style="color:black;">TOYS</span> CAMPAIGN</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: editT_campaign.php?id=$campaignId&success=true");
            exit();
        } else {
