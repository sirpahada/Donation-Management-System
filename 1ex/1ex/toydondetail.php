...
<?php } ?>
				...
				<?php if (!empty($row["toy"])) { ?>
					<label>Name of Toys:</label>
					<input type="text" value="<?php echo $row["toy"]; ?>" readonly>
				<?php } ?>
                ...
                <?php if (!empty($row["conditions"])) { ?>
					<label>Condition:</label>
					<input type="text" value="<?php echo $row["conditions"]; ?>" readonly>
				<?php } ?>
