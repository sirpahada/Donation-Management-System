...
<body>
    <div class="container">
        ...
        <div class="content">
            <h2><center>TOY <span style="color:orange;">CAMPAIGNS</center></h2>
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["delete"])) {
                ...
                if ($conn->query($sql) === TRUE) {
                    echo "<script>alert('Campaign deleted successfully.'); window.location.href = 'toycamplist.php';</script>";
                } else {
    ...
    <script>
        function editCampaign(campaignId) {
            ...
            window.location.href = "editT_campaign.php?id=" + campaignId;
        }
        ...
        function addCampaign() {
            ...
            window.location.href = "addtoycamp.php";
        }
