...
<html>
<head>
    <title>Edit Health Campaign</title>
...
<div class="col-md-10 content">
    <h2 class="white">EDIT <span style="color:black;">HEALTH</span> CAMPAIGN</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: edith_campaign.php?id=$campaignId&success=true");
            exit();
        } else {
