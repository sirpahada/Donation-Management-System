...
<body>
	...
	<div class="form-container">
		<h2>Healthcare Product Donation</h2>
		<form action="healthprocess_donation.php" method="POST">
...
<input type="hidden" name="username" value="<?php echo $username; ?>"> 
			...
			<label for="health">HealthCare Product Name</label>
			<input type="text" id="health" name="health" required>

            <label for="amount">Product Quantity (Optional)</label>
				<select name="amount" id="amount" >
				<option value="" selected disabled>Select an option</option>
    				<option value="25 people">For 25 people</option>
