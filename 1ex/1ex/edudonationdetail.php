...
<div class="content">
	...
	// Check if the four values were passed from the previous page (edudon-bycampaign.php)
	$id = $_GET["id"];
...
if (!empty($beneficiaries) && !empty($beneficiaries_location) && !empty($beneficiaries_phone) && !empty($campaign_end_date)) {
    ...
    <input type="text" value="<?php echo $beneficiaries; ?>" readonly>
<?php } ?>

<?php if (!empty($beneficiaries_location)) { ?>
    <label>Beneficiaries Location:</label>
    <input type="text" value="<?php echo $beneficiaries_location; ?>" readonly>
<?php } ?>

<?php if (!empty($beneficiaries_phone)) { ?>
    <label>Beneficiaries Phone:</label>
    <input type="text" value="<?php echo $beneficiaries_phone; ?>" readonly>
<?php } ?>

<?php if (!empty($campaign_end_date)) { ?>
    <label>Campaign End Date:</label>
    <input type="text" value="<?php echo $campaign_end_date; ?>" readonly>
<?php } ?>
