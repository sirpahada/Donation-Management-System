...
<html>
<head>
    <title>Edit Education Campaign</title>
...
<div class="col-md-10 content">
    <h2 class="white">EDIT <span style="color:black;">EDUCATION</span> CAMPAIGN</h2>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: edit_campaign.php?id=$campaignId&success=true");
            exit();
        } else {
