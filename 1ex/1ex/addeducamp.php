...
<html>
<head>
    <title>Add Education Campaign</title>
...
<div class="col-md-10 content">
    <h2 class="white">EDUCATION <span style="color:black;">CAMPAIGN</span></h2>
    ...
    <div class="sirpa">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="beneficiariesPhone" name="beneficiariesPhone" required>
            </div>
